	...
	def create(self):
		...
		with _state_machine:
			...
			OperatableStateMachine.add('replacePart',
										...
										remapping={'value': 'bin1', 'result': 'bin'})

			# x:763 y:135
			OperatableStateMachine.add('detectPartInBin_2',
										DetectFirstPartCameraAriacState(part_list=part_list, time_out=0.5),
										transitions={'continue': 'setPartTypeInBins_2', 'failed': 'failed', 'not_found': 'replacePart_3'},
			...
			OperatableStateMachine.add('detectPartInBin_3',
										DetectFirstPartCameraAriacState(part_list=part_list, time_out=0.5),
										transitions={'continue': 'setPartTypeInBins_3', 'failed': 'failed', 'not_found': 'failed'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off, 'not_found': Autonomy.Off},
										remapping={'ref_frame': 'ref_frame', 'camera_topic': 'camera_topic', 'camera_frame': 'camera_frame', 'part': 'part_Type', 'pose': 'pose'})
			...
			OperatableStateMachine.add('detectPartInBin_4',
										DetectFirstPartCameraAriacState(part_list=part_list, time_out=0.5),
										transitions={'continue': 'setPartTypeInBins_4', 'failed': 'failed', 'not_found': 'replacePart_5'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off, 'not_found': Autonomy.Off},
										remapping={'ref_frame': 'ref_frame', 'camera_topic': 'camera_topic', 'camera_frame': 'camera_frame', 'part': 'part_Type', 'pose': 'pose'})
			...
			OperatableStateMachine.add('detectPartInBin_5',
										DetectFirstPartCameraAriacState(part_list=part_list, time_out=0.5),
										transitions={'continue': 'setPartTypeInBins_5', 'failed': 'failed', 'not_found': 'replacePart_6'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off, 'not_found': Autonomy.Off},
										remapping={'ref_frame': 'ref_frame', 'camera_topic': 'camera_topic', 'camera_frame': 'camera_frame', 'part': 'part_Type', 'pose': 'pose'})
			...
			OperatableStateMachine.add('lookUpFrame',
										LookupFromTableState(parameter_name=parameter_name, table_name='bin_configuration', index_title='bin', column_title='camera_frame'),
			...
			OperatableStateMachine.add('replacePart_2',
										...
										autonomy={'done': Autonomy.Off},
										remapping={'value': 'bin2', 'result': 'bin'})

			# x:30 y:270
			OperatableStateMachine.add('replacePart_3',
										ReplaceState(),
			...
			# x:29 y:346
			OperatableStateMachine.add('replacePart_4',
										ReplaceState(),
			...
			# x:31 y:430
			OperatableStateMachine.add('replacePart_5',
										ReplaceState(),
			...
			# x:34 y:537
			OperatableStateMachine.add('replacePart_6',
										ReplaceState(),
										transitions={'done': 'lookUpTopic_6'},
										autonomy={'done': Autonomy.Off},
										remapping={'value': 'bin6', 'result': 'bin'})

			# x:1009 y:52
			OperatableStateMachine.add('setPartTypeInBins',
										setBinPartType(),
										transitions={'continue': 'replacePart_2'},
			...
			OperatableStateMachine.add('setPartTypeInBins_2',
										setBinPartType(),
										transitions={'continue': 'replacePart_3'},
										autonomy={'continue': Autonomy.Off},
										remapping={'bin': 'bin', 'part_Type': 'part_Type', 'bin_Content': 'bin_Content'})
			...
			OperatableStateMachine.add('setPartTypeInBins_3',
										setBinPartType(),
										transitions={'continue': 'lookUpFrame_3'},
										autonomy={'continue': Autonomy.Off},
										remapping={'bin': 'bin', 'part_Type': 'part_Type', 'bin_Content': 'bin_Content'})
			...
			OperatableStateMachine.add('setPartTypeInBins_4',
										setBinPartType(),
										transitions={'continue': 'replacePart_5'},
										autonomy={'continue': Autonomy.Off},
										remapping={'bin': 'bin', 'part_Type': 'part_Type', 'bin_Content': 'bin_Content'})
			...
			OperatableStateMachine.add('detectPartInBin',
										DetectFirstPartCameraAriacState(part_list=part_list, time_out=0.5),
										transitions={'continue': 'setPartTypeInBins', 'failed': 'failed', 'not_found': 'replacePart_2'},
										autonomy={'continue': Autonomy.Off, 'failed': Autonomy.Off, 'not_found': Autonomy.Off},
										remapping={'ref_frame': 'ref_frame', 'camera_topic': 'camera_topic', 'camera_frame': 'camera_frame', 'part': 'part_Type', 'pose': 'pose'})
