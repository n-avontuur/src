...
class place_part_on_binSM(Behavior):
	...
	def create(self):
		...
		# x:64 y:383, x:507 y:311
		_state_machine = OperatableStateMachine(outcomes=['finished', 'failed'], input_keys=['partType', 'gasket', 'piston', 'gear'])
		...
		with _state_machine:
			...
			OperatableStateMachine.add('getStatusGripper',
										...
										transitions={'continue': 'finished', 'fail': 'wait_2_2'},
			...
			OperatableStateMachine.add('locate_Place_In_Bin_With_Content',
										...
										transitions={'finished': 'moveToPregrasp', 'failed': 'failed', 'not_found': 'getPartLocation'},
