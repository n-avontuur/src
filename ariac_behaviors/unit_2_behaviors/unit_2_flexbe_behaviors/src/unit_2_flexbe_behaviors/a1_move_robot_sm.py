...
class a1_Move_RobotSM(Behavior):
	...
	def create(self):
		...
		_state_machine = OperatableStateMachine(outcomes=['finished', 'failed'], input_keys=['pick_Pose', 'pick_offset', 'pick_rotation', 'drop_Pose', 'drop_Offset', 'drop_Offset', 'robot_Name', 'preDrop_Config'])
		...
		with _state_machine:
			...
			OperatableStateMachine.add('set_Robot_Parameters',
										...
										remapping={'robot_Name': 'robot_Name', 'move_group': 'move_group', 'action_topic_namespace': 'action_topic_namespace', 'action_topic': 'action_topic', 'robot_name': 'robot_name', 'tool_link': 'tool_link', 'gripper_service': 'gripper_service', 'gripper_status_topic': 'gripper_status_topic', 'gripper_status_attached': 'gripper_status_attached', 'gripper_status_enabled': 'gripper_status_enabled', 'PrePick_config': 'PrePick_config'})
			...
			# x:1006 y:421
			OperatableStateMachine.add('compute_Pick_2',
										ComputeGraspAriacState(joint_names=joint_names),
			...
			OperatableStateMachine.add('move_To_PreDrop',
										...
										transitions={'reached': 'compute_Pick_2', 'planning_failed': 'wait_3', 'control_failed': 'wait_3', 'param_error': 'move_To_PrePick'},
			...
			OperatableStateMachine.add('move_To_PrePick',
										SrdfStateToMoveitAriac(),
										transitions={'reached': 'compute_Pick', 'planning_failed': 'wait', 'control_failed': 'wait', 'param_error': 'failed'},
										autonomy={'reached': Autonomy.Off, 'planning_failed': Autonomy.Off, 'control_failed': Autonomy.Off, 'param_error': Autonomy.Off},
