...
class setNewPosePart(EventState):
	...
	def on_enter(self, userdata):
		...
		self._numberParts=userdata.part_Content[1][0]
		self._maxNumberPartsX=userdata.part_Content[2][0]
		self._maxNumberPartsY=userdata.part_Content[2][1]
		self._offsetSize_x=userdata.part_Content[3][0]
		self._offsetSize_y=userdata.part_Content[3][1]
		self._offsetSize_z=userdata.part_Content[3][2]
		pass
