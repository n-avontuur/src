...
class setFirstTimePart(EventState):
	...
	def execute(self, userdata):
		...
		userdata.piston=[[userdata.piston_offset],[0.035],[0],[3,3]] #offsetXY,offsetZ,numberParts,matrixXY
		userdata.gear=[[userdata.piston_offset],[0.035],[0],[4,3]]	#offsetXY,offsetZ,numberParts,matrixXY
		return 'continue'
